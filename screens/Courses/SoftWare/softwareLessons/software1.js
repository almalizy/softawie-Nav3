...
conditional=()=>{
     ...
     ? this.props.navigation.navigate('_2S') && this.setState({counter:counter+1})
      ...
      <View>
              <View style={{margin:10,alignItems:'center',justifyContent:'center'}}>
                  <Text  style={{color:'blue',fontWeight:'bold',fontSize: 20 }} > 
                        الدرس الثاني برامج السوفت وير المجانية  
                          </Text>
              </View>
              <View>
                  {this.renderDetails2()}
...
conditional=()=>{
     this.state.choice1 == false && this.state.choice2 == true && this.state.choice3 == false
     ? this.props.navigation.navigate('_3S')  && this.setState({counter:counter+1})
     : Alert.alert("هناك خطأ\n ارجع الي الدرس السابق ثم أعد المحاولة من فضلك")
}
  render() {
    return (
...
conditional=()=>{
     this.state.choice1 == true && this.state.choice2 == true && this.state.choice3 == true || this .state.choice4 == true
     ? this.props.navigation.navigate('software2')
     : Alert.alert("هناك خطأ\n ارجع الي الدرس السابق ثم أعد المحاولة من فضلك")
}
  render() {
    return (
